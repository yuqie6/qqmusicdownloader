...
const FAQPage = () => {
  const faqs = [
    ...
    {
      question: "下载的音乐在哪里？",
      answer: "默认情况下，音乐会下载到您的桌面‘QQMusic’文件夹中。您可以在软件中找到下载好的音乐文件。未来的版本中，我们会添加自定义下载路径的功能。"
    },
    {
      question: "音乐无法下载怎么办？",
      answer: "如果遇到下载问题，请检查：1. 网络连接是否正常；2. 是否有足够的磁盘空间；3. 杀毒软件是否拦截了下载。如果问题依然存在，可以在GitHub上提交issue，我们会及时处理。"
    },
    {
      question: "为什么选择开源？",
      answer: "我们选择开源是因为相信透明和共享能创造更好的软件。这不仅让用户可以验证软件的安全性，也欢迎社区贡献，一起让这个工具变得更好。"
    },
    {
      question: "未来会有更多功能吗？",
      answer: "当然！我们计划添加更多功能，如批量下载、音质选择、歌词下载等。我们重视用户反馈，欢迎在GitHub上提出您的建议。"
    },
    {
        question: "软件安装在哪？",
